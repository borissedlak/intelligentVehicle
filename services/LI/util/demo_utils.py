...
from services.LI.util.misc import make_folder, time_synchronized
from services.LI.util.evaluation_utils import decode, post_processing
from services.LI.util.torch_utils import _sigmoid

src_dir = os.path.dirname(os.path.realpath(__file__))
while not src_dir.endswith("LI"):
